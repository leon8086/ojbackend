...
public class SubmissionTableDef extends TableDef {
 ...
 @since 2024-06-03
     */
    public static final SubmissionTableDef SUBMISSION = new SubmissionTableDef();
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, IP, CODE, INFO, RESULT, SHARED, USER_ID, LANGUAGE, USERNAME, CONTEST_ID, PROBLEM_ID, CREATE_TIME, STATISTIC_INFO};

    public SubmissionTableDef() {
        super("", "submission");
    }

    private SubmissionTableDef(String schema, String name, String alisa) {
        super(schema, name, alisa);
    }

    public SubmissionTableDef as(String alias) {
        String key = getNameWithSchema() + "." + alias;
        return getCache(key, k -> new SubmissionTableDef("", "submission", alias));
    }
