...
public class ExamSubmissionTableDef extends TableDef {
 ...
 @since 2024-06-26
     ...
     */
    public final QueryColumn[] DEFAULT_COLUMNS = new QueryColumn[]{ID, IP, CODE, INFO, EXAM_ID, RESULT, SHARED, USER_ID, LANGUAGE, USERNAME, CONTEST_ID, PROBLEM_ID, CREATE_TIME, STATISTIC_INFO};
